 ...
 */
function pfxToPem(pfxBytes: Buffer, passphrase: string | undefined): { cert: Buffer; key: Buffer } {
...
function normalizeProxyUrl(proxy?: string | ProxyConfig): string | undefined {
